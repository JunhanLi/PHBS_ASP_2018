...
class BsmModel:
    ...
    def delta(self, strike, spot, texp, cp_sign=1):
        ...
        d1 = np.log(forward/strike)/vol_std + 0.5*vol_std
        option_delta = cp_sign*div_fac*ss.norm.cdf(cp_sign*d1)
        return option_delta
    ...
    def vega(self, strike, spot, texp, cp_sign=1):
        ...
        option_vega = spot*div_fac*np.sqrt(texp)*ss.norm.pdf(d1)
    ...
    def gamma(self, strike, spot, texp, cp_sign=1):
        ...
        option_gamma = div_fac*ss.norm.pdf(d1)/(spot*vol_std)
